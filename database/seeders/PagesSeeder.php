    ...
    public function run()
    {
        DB::table('pages')->insert([
            ...
            'content' => '<p><strong>Dasturxon website Terms of Use</strong><br />
                            ...
                            <br />
                            The following is a partial list of the kinds of conduct that are illegal or prohibited on the Websites. Dasturxon reserves the right to investigate and take appropriate legal action against anyone who, in Dasturxon sole discretion, engages in any of the prohibited activities. Prohibited activities include &mdash; but are not limited to &mdash; the following:<br />
                            <br />
                            ...
                            - Posting Content that is unlawful, obscene, defamatory, threatening, harassing, abusive, slanderous, hateful, or embarrassing to any other person or entity as determined by Dasturxon in its sole discretion or pursuant to local community standards;<br />
                            - Posting Content that constitutes cyber-bullying, as determined by Dasturxon in its sole discretion;<br />
                            ...
                            - Posting anything that may be &ldquo;spam,&rdquo; as determined by Dasturxon in its sole discretion;<br />
                            ...
                            - Engaging in any other conduct that restricts or inhibits any other person from using or enjoying the Websites, or which, in the sole discretion of Dasturxon, exposes Dasturxon or any of its customers, suppliers, or any other parties to any liability or detriment of any type; or<br />
                            - Encouraging other people to engage in any prohibited activities as described herein.<br />
                            Dasturxon reserves the right -- but is not obligated -- to do any or all of the following:<br />
                            <br />
                            ...
                            - Dasturxon Trademarks and Copyrights<br />
                            <br />
                            All trademarks, logos, and service marks displayed on the Website are registered and unregistered Trademarks of Dasturxon and/or third parties who have authorized their use (collectively the &ldquo;Trademarks&rdquo;)<br />
                            <br />
                            You may not use, copy, reproduce, republish, upload, post, transmit, distribute, or modify these Trademarks in any way. The use of Dasturxon&#39;s trademarks on any other website is strictly prohibited. All of the materials contained on the Websites are copyrighted except where explicitly noted otherwise. Dasturxon will aggressively enforce its intellectual property rights to the fullest extent of the law, including the seeking of criminal prosecution. Dasturxon neither warrants nor represents that your use of materials displayed on the Websites will not infringe rights of third parties not owned by or affiliated with Dasturxon. Use of any materials on the Websites is at your own risk.<br />
                            <br />
                            <strong>Hyperlinks</strong><br />
                            <br />
                            This Websites may contain hyperlinks to third-party websites. Dasturxon does not control or endorse these third-party websites or any goods or services sold on those websites. Some of these websites may contain materials that are objectionable, unlawful, or inaccurate. You acknowledge and agree that Dasturxon is not responsible or liable for any Content or other materials on these third party websites.<br />
                            <br />
                            ...
                            <br />
                            The Websites and the Content are provided on an &ldquo;as is&rdquo; basis. To the fullest extent permitted by law, Dasturxon, its parent, subsidiaries, and affiliates (the Dasturxon entities), and each of their agents, representatives and service providers, disclaim all warranties, either expressed or implied, statutory or otherwise, including but not limited to the implied warranties of merchantibility, non-infringement of third parties rights, and fitness for particular purpose. Applicable law may not allow the exclusion of implied warranties, so the above exclusion may not apply to you. The Dasturxon Entities, their agents, representatives and service providers cannot and do not guarantee or warrant that: (a) the Websites will be reliable, accurate, complete, or updated on a timely basis; (b) the Websites will be free of human and machine errors, omissions, delays, interruptions or losses, including loss of data; (c) any files available for downloading from the Websites will be free of infection by viruses, worms, Trojan horses, or other codes that manifest contaminating or destructive properties; (d) any Content you post on the Websites will remain on the Websites; or (e) the functions or services performed on the Websites will be uninterrupted or error-free or that defects in the Websites will be corrected.<br />
                            <br />
                            <strong>Limitation of Liability</strong><br />
                            <br />
                            The Dasturxon entities, their agents, representatives, and service providers, entire liability and your exclusive remedy with respect to your use of the websites is to discontinue your use of the websites. The Dasturxon entities, their agents, representatives, and service providers shall not be liable for any indirect, special, incidental, consequential, or exemplary damages arising from your use of the websites or for any other claim related in any way to your use of the websites. These exclusions for indirect, special, consequential, and exemplary damages include, without limitation, damages for lost profits, lost data, loss of goodwill, work stoppage, work stoppage, computer failure, or malfunction, or any other commercial damages or losses, even if the Dasturxon entities, their agents, representatives, and service providers have been advised of the possibility thereof and regardless of the legal or equitable theory upon which the claim is based. Because some states or jurisdictions do not allow the exclusion or the limitation of liability for consequential or incidental damages, in such states or jurisdictions, the Dasturxon entities, their agents, representatives and service providers&#39; liability shall be limited to the extent permitted by law.<br />
                            <br />
                            <strong>Termination</strong><br />
                            <br />
                            Dasturxon has the right to terminate your account and access to the Websites for any reason, including, without limitation, if Dasturxon, in its sole discretion, considers your use to be unacceptable, or in the event of any breach by you of the Terms of Use. Dasturxon may, but shall be under no obligation to, provide you a warning prior to termination of your use of the Websites.<br />
                            <br />
                            ...
                            - Dasturxon reserves the right to cancel orders and accounts if fraud activities are detected<br />
                            - Dasturxon reserves the right to stop this voucher to be used on certain restaurants without prior notice<br />
                            - Individual restaurants terms &amp; conditions apply<br />
                            <br />
                            <strong>Contact Us</strong><br />
                            <br />
                            Questions? Comments? Please send an email to us at&nbsp;contact@Dasturxon.com<br />
                            <br />
                            &copy; 2020 Dasturxon. All rights reserved.</p>',
            'showAsLink' => 1,
            'created_at' => now(),
            'updated_at' => now(),
        ]);
        ...
        DB::table('pages')->insert([
            'title' => 'How it works',
            'content' => '<p>Dasturxon is simple and easy way to order food online. Enjoy the variety of choices and cuisines which could be delivered to your home or office.</p>

                        <p>&nbsp;</p>

                        <p><strong>Here is how Dasturxon works:</strong><br />
                        &nbsp;</p>
        ...
        /*DB::table('pages')->insert([
            ...
            'content' => '<p>You have a great restaurant and deliver the most delicious food in your city?<br />
                        You want the customers of Dasturxon&nbsp;to be satisfied by your offers and discounts?</p>

                        <p><strong>Dasturxon always looks for new friends!</strong></p>
